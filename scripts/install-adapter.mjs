...
async function copyRuntimeBundle(destination) {
  const files = [
    ...
    "src/savings-policy.mjs",
    "src/skill-disclosure.mjs",
    "src/zero-token-memory.mjs",
    "src/tool-state.mjs",
    "src/workflow-pruner.mjs",
    ...
    "references/controls/mayo.md",
    "references/controls/mustard.md",
    "references/controls/ketchup.md",
    "references/controls/ranch.md",
    "references/controls/hot.md",
    "references/hosts/openclaw.md",
  ...
  const runtimePackage = {
    ...
    bin: {
      ...
      "condiments-savings-policy": "scripts/savings-policy.mjs",
      "condiments-skill-disclosure": "scripts/skill-disclosure.mjs",
      "condiments-zero-memory": "scripts/zero-token-memory.mjs",
      "condiments-tool-state": "scripts/tool-state.mjs",
      "condiments-workflow-pruner": "scripts/workflow-pruner.mjs",
    },
  };
